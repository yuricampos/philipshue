package src.com.philips.lighting.gui;
...
import src.com.philips.lighting.Controller;
...
public class PushLinkFrame extends JDialog {
    ...
    public class PushLinkImagePanel extends JPanel {
        ...
        public PushLinkImagePanel() {
            try {
                image = ImageIO.read(PushLinkFrame.class.getResourceAsStream("/src/pushlink_image.png"));
